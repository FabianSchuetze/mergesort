...
\end{figure}
    ...
    \red{Approachable:} CUDA: Extension to C, called from C/C++
\end{frame}
...
\only<3->{
\qquad \green{2. Threads to Processors:} Wrappend threads are allocated\\
}
\end{overlayarea}
\end{frame}
...
\begin{frame}
\frametitle{Reason: Too much global meory access}
