...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.17]{memory_hirachy.png}
\end{figure}
\red{Visibility:\\}
\green{Global Memory:} Can be accessed by all threads\\
\green{Shared Memory:} Private for each Block\\
\green{Registers:} Private for each Thread\\
\red{Size:\\}
\green{Global Memory:} 2 GB
\green{Shared Memory:} Total: 192 KB, per block: 48 KB
\red{Latency:\\}
\green{Global Memory:} 8 GB/s
\green{Shared Memory:} 80 GB/s
\end{frame}
